...
import { marbelProducts } from "../data/products";

export default function Marbel() {
  useEffect(() => { document.title = "Marbel Collection | Vishal Timbers"; }, []);
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="text-center mb-10 sm:mb-14">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl mb-4">Marbel</h1>
        ...
        <ProductGrid products={marbelProducts} />
      </main>
      <SiteFooter />
    </div>
  );
