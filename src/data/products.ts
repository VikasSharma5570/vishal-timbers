...
export const terracottaProducts: Product[] = [
...
export const papierProducts: Product[] = [
...
export const woodenProducts: Product[] = [
...
export const allProducts: Product[] = [...terracottaProducts, ...papierProducts, ...woodenProducts];
